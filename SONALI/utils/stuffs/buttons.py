...
class BUTTONS(object):
    ...
    ABUTTON = [[InlineKeyboardButton("˹ ᴍᴜsɪᴄ ˼", url=config.SUPPORT_CHAT"),InlineKeyboardButton("˹ ᴛᴏᴏʟs ˼", callback_data=f"mbot_cb")],[InlineKeyboardButton("˹ ᴍᴀɴᴀɢᴇ ˼", callback_data=f"bbot_cb"),
